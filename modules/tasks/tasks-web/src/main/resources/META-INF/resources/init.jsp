...
page import="com.liferay.tasks.constants.TasksEntryConstants" %><%@
...
page import="com.liferay.tasks.constants.TasksEntryPortletKeys" %><%@
page import="com.liferay.tasks.constants.TasksEntryWebKeys" %><%@
