...
public class TasksEntryModelImpl extends BaseModelImpl<TasksEntry>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.tasks.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.tasks.model.TasksEntry"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.tasks.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.tasks.model.TasksEntry"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.tasks.service.util.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.tasks.service.util.ServiceProps.get(
