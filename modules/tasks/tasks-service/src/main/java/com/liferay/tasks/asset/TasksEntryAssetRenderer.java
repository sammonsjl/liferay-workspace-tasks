...
import com.liferay.tasks.constants.TasksEntryWebKeys;
...
public class TasksEntryAssetRenderer extends BaseJSPAssetRenderer<TasksEntry> {
	...
	public String getURLViewInContext(
		...
		try {
			...
			long portletPlid = PortalUtil.getPlidFromPortletId(
				user.getGroupId(), true, TasksEntryPortletKeys.TASKS);

			PortletURL portletURL = PortletURLFactoryUtil.create(
				liferayPortletRequest, TasksEntryPortletKeys.TASKS, portletPlid,
	...
	public boolean include(
		...
		request.setAttribute(TasksEntryWebKeys.TASKS_ENTRY, _entry);
